...
const photos: PhotoItem[] = [
  ...
  { id: "samuel", title: "Samuel", location: "", year: "", category: "PEOPLE", caption: "Portrait from the wider archive.", image: "/images/odin/gold/samuel.webp", orientation: "portrait" },
  ...
  { id: "girson", title: "Girson NMG", location: "", year: "", category: "CULTURE", caption: "Music, light and the human world belong in the archive too.", image: "/images/odin/gold/girson-nmg.webp", orientation: "portrait" },
  { id: "napoleon", title: "Napoleon", location: "", year: "", category: "CULTURE", caption: "History, objects and institutions are part of how we see the present.", image: "/images/odin/gold/napoleon.webp", orientation: "portrait" },
  { id: "canggu", title: "Canggu", location: "", year: "", category: "CULTURE", caption: "A different register of the same world.", image: "/images/odin/gold/aksel-canggu.webp", orientation: "portrait" },
  { id: "snohette", title: "Snøhette", location: "", year: "", category: "EXPEDITIONS", caption: "Movement, weather and the work of getting there.", image: "/images/odin/gold/snohette.webp", orientation: "portrait" },
