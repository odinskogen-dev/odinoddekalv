    ...
    <div className="pt-16 md:pt-24">
      <header className="container-editorial">
        <Reveal>
          ...
          <p className="mt-9 max-w-2xl text-xl leading-relaxed text-ink/58">A short factual introduction for journalists, collaborators and talks.</p>
        </Reveal>
      </header>
      ...
      <main className="container-editorial mt-16 md:mt-24">
        <Reveal className="grid gap-10 md:grid-cols-12 md:items-start">
          ...
          <div className="md:col-span-6 md:col-start-7">
            ...
            <p className="mt-6 text-2xl font-medium leading-snug tracking-tight text-ink md:text-4xl">Odin Oddekalv is a Norwegian founder and photographer exploring how humans can thrive without weakening the living world we depend on.</p>
            <p className="mt-7 text-lg leading-relaxed text-ink/60">He is building 4PLANET to make ecological knowledge, relationships and action easier to understand and use. Photography, writing and field work keep that work connected to real places, animals and people.</p>
            <p className="mt-5 text-lg leading-relaxed text-ink/60">He grew up close to environmental action through his father, Norwegian environmental campaigner Kurt Oddekalv. After losing him, the question became how to carry responsibility forward in a different generation and in his own language.</p>
          </div>
        </Reveal>

        <Reveal className="mt-20 border-t border-ink/10 md:mt-28">
          <div className="grid gap-8 border-b border-ink/10 py-8 md:grid-cols-12"><p className="font-mono text-[0.67rem] uppercase tracking-label text-ink/45 md:col-span-3">CURRENT WORK</p><div className="md:col-span-8 md:col-start-5"><p className="text-xl leading-relaxed text-ink/70">4PLANET_ · ecological intelligence and action<br />P4NTHER_ · culture and creative work<br />Photography · writing · field stories</p></div></div>
