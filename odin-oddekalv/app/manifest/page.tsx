  ...
  return (
    <div className="pt-16 md:pt-24">
      <header className="container-editorial">
        <Reveal>
          <TypeLabel index="01" accent>Manifest</TypeLabel>
      ...
      <section className="container-editorial mt-24 md:mt-36">
        <Reveal className="border-y border-ink/10 py-14 md:py-20">
      ...
      <section className="container-editorial mt-24 md:mt-36">
        <Reveal className="grid gap-10 md:grid-cols-12">
          ...
          <div className="space-y-7 text-lg leading-relaxed text-ink/75 md:col-span-7 md:text-xl">
            ...
            <Link href="/projects" className="group inline-flex items-center gap-2 font-mono text-sm uppercase tracking-label text-ink transition-colors hover:text-blue"><span className="link-underline">See what I am building</span><span>→</span></Link>
          </div>
        </Reveal>
      </section>
    </div>
